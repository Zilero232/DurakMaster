...
/** Карточка игрока в списке столов — только публичные поля. */
...
export const lobbyTableSchema = z.object({
  ...
  /** Есть ли за столом премиум-игрок — такие столы поднимаются в списке. */
